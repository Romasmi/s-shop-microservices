...
const file_user_events_proto_rawDesc = "" +
	"\n" +
	"\x11user_events.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\n" +
	"user.proto\"\x85\x01\n" +
	...
	".user.UserR\x04userB\x92\x01\n" +
	"\bcom.userB\x0fUserEventsProtoP\x01ZEgithub.com/Romasmi/s-shop-microservices/user-service/internal/api;api\xa2\x02\x03UXX\xaa\x02\x04User\xca\x02\x04User\xe2\x02\x10User\\GPBMetadata\xea\x02\x04Userb\x06proto3"

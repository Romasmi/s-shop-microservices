...
func (*OrderPlaced_Order) Descriptor() ([]byte, []int) {
	return file_order_events_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*OrderPlaced_PaymentResult) Descriptor() ([]byte, []int) {
	return file_order_events_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*OrderPlaced_UserInfo) Descriptor() ([]byte, []int) {
	return file_order_events_proto_rawDescGZIP(), []int{0, 2}
}
...
const file_order_events_proto_rawDesc = "" +
	"\n" +
	"\x12order_events.proto\x12\x05order\x1a\x1fgoogle/protobuf/timestamp.proto\"\x98\x04\n" +
	...
	"\x05email\x18\x02 \x01(\tR\x05emailB\x94\x01\n" +
	"\tcom.orderB\x10OrderEventsProtoP\x01ZAgithub.com/Romasmi/s-shop-microservices/order-service/pkg/api;api\xa2\x02\x03OXX\xaa\x02\x05Order\xca\x02\x05Order\xe2\x02\x11Order\\GPBMetadata\xea\x02\x05Orderb\x06proto3"
